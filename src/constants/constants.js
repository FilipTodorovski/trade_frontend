...
export const PRIMARY_RED_BACK_COLOR = 'rgba(232,87,87, 0.1)';
...
export const ADYEN_PAYOUT_TYPE = [
  { value: 'Merchant', label: 'Merchant' },
  { value: 'Partner', label: 'Partner' },
];

export const ADYEN_PAYOUT_STATUS = [
...
export const STRIPE_PAYMENT_METHOD_TYPES = [{ value: 'card', label: 'Card' }];

export const STRIPE_PAYMENT_STATUS = [
  { value: 'succeeded', label: 'Succeeded' },
  { value: 'requires_payment_method', label: 'Require Payment Method' },
];
