      ...
      <LayoutWrapper>
          ...
          <div className="banner-container">
            <HeadContentWrapper>
              ...
              <h4 className="banner-description">
                Order a {makeCapitalCase(foodtype)} takeaway near you tonight
              </h4>
              <SearchInputGroup>
                <SearchInput
                  type="text"
        ...
        <CountrySelectSection>
          <MainContainer className="cityselect-container">
            <SectionH5>{makeCapitalCase(foodtype)} Food Near You</SectionH5>
            <SectionH2>Choose your City</SectionH2>
            <Row className="city-content">
              <Col className="order-content-col" md={2} sm={3} xs={4}>
                <h5>
                  <Link to={`/takeaway/London/${makeCapitalCase(foodtype)}`}>
                    London
                  </Link>
                </h5>
              </Col>
              <Col className="order-content-col" md={2} sm={3} xs={4}>
                <h5>
                  <Link to={`/takeaway/Edinburgh/${makeCapitalCase(foodtype)}`}>
                    Edinburgh
                  </Link>
                </h5>
              </Col>
              <Col className="order-content-col" md={2} sm={3} xs={4}>
                <h5>
                  <Link
                    to={`/takeaway/Manchester/${makeCapitalCase(foodtype)}`}
                  >
                    Manchester
                  </Link>
                </h5>
              ...
              <Col className="order-content-col" md={2} sm={3} xs={4}>
                <h5>
                  <Link to={`/takeaway/Glasgow/${makeCapitalCase(foodtype)}`}>
                    Glasgow
                  </Link>
                </h5>
              </Col>
              <Col className="order-content-col" md={2} sm={3} xs={4}>
                <h5>
                  <Link to={`/takeaway/Newcastle/${makeCapitalCase(foodtype)}`}>
                    Newcastle
                  </Link>
                </h5>
              </Col>
              <Col className="order-content-col" md={2} sm={3} xs={4}>
                <h5>
                  <Link to={`/takeaway/Aberdeen/${makeCapitalCase(foodtype)}`}>
                    Aberdeen
                  </Link>
                </h5>
              </Col>
        ...
        <SlideSection>
          <MainContainer className="slide-container">
            ...
            <SectionH2>Looking for another choice?</SectionH2>
            <FavouriteFoodSlider
...
export default FoodTypeNearmeLanding;
