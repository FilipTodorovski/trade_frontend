  ...
  return (
    <StoreFrontMasterComponent>
      <LayoutWrapper>
          ...
          <div className="banner-container">
            <HeadContentWrapper>
              <h1 className="banner-title">
                Order Takeaway
                <br />
                Delivery in {makeCapitalCase(city)}
              </h1>
              <h4 className="banner-description">
                Order from your favourite {makeCapitalCase(city)} takeaway and
                restaurants online
              </h4>
              <SearchInputGroup>
                <SearchInput
        ...
        <ServiceSection>
          <MainContainer>
            <div className="section-container">
              <SectionH2 center>
                How to order your favourite {makeCapitalCase(city)} food <br />{' '}
              ...
              <div className="service-features">
                <div className="service">
                  ...
                  <p>
                    Browse the menu from your favourite {makeCapitalCase(city)}{' '}
                    takeaway and select what you would like.
                  </p>
                </div>
                <div className="service">
        ...
        <OrderFromSection>
          <MainContainer className="orderfrom-container">
            <SectionH5>
              Order your from your favourite {makeCapitalCase(city)} Takeaways
            </SectionH5>
            <SectionH2>
              Takeaways to Order from in {makeCapitalCase(city)}
            </SectionH2>
...
const OrderFromSection = styled.div`
  display: flex;
  padding: 80px 0 71px;
  justify-content: center;
  flex-direction: column;
