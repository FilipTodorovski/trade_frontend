...
import ChineseFooodType from './assets/images/Chinese-FoodType.png';

const pusher = new Pusher(CONFIG.APP_PUSHER_APP_KEY, {
  cluster: 'eu',
});
const orderChannel = pusher.subscribe(CONFIG.APP_PUSHER_ORDER_CHANNEL);
const payoutChannel = pusher.subscribe(CONFIG.APP_PUSHER_PAYOUT_CHANNEL);

export const getPusherOrderChannel = () => {
  return orderChannel;
};

export const getPusherPayoutChannel = () => {
...
export const MENU_ITEMS_SECTION = 'Items';
...
export const getBackImageOfFoodType = (nType) => {
  try {
    if (nType.toLowerCase() === 'chinese') return ChineseFooodType;
    return ChineseFooodType;
  } catch (err) {
    return ChineseFooodType;
  }
};
...
export const ADYEN_ACCOUNT_LEGAL_ENTITY = {
  BUSINESS: 'Business',
...
export const LEGAL_ENTITY_OPTIONS = [
  {
    value: ADYEN_ACCOUNT_LEGAL_ENTITY.INDIVIDUAL,
    label: 'Individual/sole trader ',
  },
  {
    value: ADYEN_ACCOUNT_LEGAL_ENTITY.BUSINESS,
    label: 'Private Limited Company',
  },
];

export const BUSINESS_OWNERS = {
  ONLY_OWNER: 'I am the only owner',
  ADD_ANOTHER: 'Add another owner, or a director',
};

export const ADYEN_DOCUMENT_TYPE = {
  PASSPORT: 'PASSPORT',
...
export const ADYEN_PAYOUT_SCHEDULE_OPTIONS = [
...
// export const DEFAULT_ACCOUNT_HOLDER = {
//   Business: {
//     accountHolderCode: '',
...
export const ADYEN_TRANSACTION_STATUS = [
  { value: 'Chargeback', label: 'Chargeback' },
  { value: 'ChargebackCorrection', label: 'Chargeback correction' },
  {
    value: 'ChargebackCorrectionReceived',
    label: 'Chargeback correction received',
  },
  { value: 'ChargebackReceived', label: 'Chargeback received' },
  { value: 'ChargebackReversed', label: 'Chargeback reversed' },
  {
    value: 'ChargebackReversedCorrection',
    label: 'Chargeback reversed correction',
  },
  {
    value: 'ChargebackReversedCorrectionReceived',
    label: 'Chargeback reversed correction received',
  },
  {
    value: 'ChargebackReversedReceived',
    label: 'Chargeback reversed received',
  },
  { value: 'CreditClosed', label: 'Closed credit' },
  { value: 'Converted', label: 'Converted' },
  { value: 'CreditFailed', label: 'Credit failed' },
  { value: 'Credited', label: 'Credited' },
  { value: 'DebitFailed', label: 'Debit failed' },
  { value: 'DebitReversedReceived', label: 'Debit reversed received' },
  { value: 'Debited', label: 'Debited' },
  { value: 'DebitedReversed', label: 'Debited reversed' },
  { value: 'Fee', label: 'Fee' },
  { value: 'FundTransfer', label: 'Fund transfer' },
  { value: 'FundTransferReversed', label: 'Fund transfer reversed' },
  { value: 'ManualCorrected', label: 'Manual corrected' },
  { value: 'Payout', label: 'Payout' },
  { value: 'PayoutReversed', label: 'Payout reversed' },
  { value: 'PendingCredit', label: 'Pending credit' },
  { value: 'PendingDebit', label: 'Pending debit' },
  { value: 'PendingFundTransfer', label: 'Pending fund transfer' },
  { value: 'SecondChargeback', label: 'Second chargeback' },
  { value: 'SecondChargebackReceived', label: 'Second chargeback received' },
  { value: 'CreditSuspended', label: 'Suspended credit' },
  { value: 'CreditReversed', label: 'creditReversed' },
  { value: 'CreditReversedReceived', label: 'creditReversedReceived' },
];
